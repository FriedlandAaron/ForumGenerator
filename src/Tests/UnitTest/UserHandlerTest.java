...
public class UserHandlerTest  extends TestCase {
	...
	public void setUp() throws Exception {
		...
		forum =Forum.createForum( "hadaramran" , "12374567" ,p ,admins, "Cat");		
	...
	public void testDeleteSubForum() {
		...
		assertTrue(this.member_1.deleteSubForum("Music"));
	...
	public void testCreate_thread() {
		...
		this.member_1.login("hadar_1", "ssdasda");		
		this.member_1.createSubForum("Sport" , (new String[]{"alin"}) );
		assertTrue(this.member_4.create_thread("sjhgdjahs", "ashgd", "Sport"));
		assertFalse(this.member_4.create_thread("sjhgdjahs", "ashgd",  ""));
	}
	...
	public void testShow_ReplyPost() {
		...
		this.member_1.login("hadar_1", "ssdasda");		
		this.member_1.createSubForum("Sport" , (new String[]{"alin"}) );
		this.member_4.create_thread("sjhgdjahs", "ashgd","Sport");
		this.member_4.create_thread("sjhgdjahs", "ashgd",  "");
	...
	public void testAddMemberType() {
		...
		UserHandler admin = new UserHandler(this.forum);
