...
import Network_layer.reactorServer.protocol.AsyncServerProtocol;
import Network_layer.reactorServer.tokenizer.MessageTokenizer;
...
public class ConnectionHandler<T> {
	 ...
	 */
	public ConnectionHandler(SocketChannel sChannel, ReactorData<T> data, SelectionKey key) {
		_sChannel = sChannel;
		_data = data;
    ...
    public AsyncServerProtocol<T> GetProtocol(){
    	return _protocol;
    }
	public void Print(T msg) {
		try {
		this.addOutData(_tokenizer.getBytesForMessage(msg));
