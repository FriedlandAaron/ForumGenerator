...
public class ForumMessage implements Message<ForumMessage>, java.io.Serializable {
	...
	public enum ForumMessageReturnType  implements ForumMessageMinorType  {ERROR , BOOLEAN, VEC_ISUBFORUM, ISUBFORUM, VEC_IPOST, INTEGER, 
																			STRING, IFORUM, VEC_IUSER, VEC_COMP, STARTDATE, STATUS, MEMBERTYPE, IUSER, STRING_ARRAY, VEC_SESSIONS  };
	...
	public enum ForumMessageCommendType implements ForumMessageMinorType {LOGIN , LOGOUT, REGISTER, CR_SUBFORUM, SH_SUBFORUM, CR_THREAD, CR_REPLYPOST, SEARCH_SUBFORUM, 
																			CHAN_POLICY, SH_REPLYPOST, SH_THREADPOST, DELETE_POST, ADD_COMP_MOD, ADD_MEMBER_TYPE, 
																			REM_MEMBER_TYPE, GET_NUM_MEMBER_TYPE, GET_USERNAME, GET_FORUM, 
																			  GET_STARTDATE_USER, GET_STATUS, GET_CUR_USR,
																			ADD_MODERATOR, DEL_MODERATOR, NUM_SUBFORUM, NUM_SHARED_MOD, NUM_POSTS_SUBFORUM, NUM_POSTS_USER, MODERATORS_LIST, MODERATORS_REPORT, SET_METHOD_POLICY,
																			 ...
																			 GET_THREADS_SUBFORUM, 																			
																			REGISTER_EMAIL, SUBMIT_CODE_REG, FORUM_NAME, GET_REPLYPOST_POST, SH_SUBFORUM_NAMES, DELETE_SUBFORUM_THEME, 
																			
																			OBSERVE, SESSIONS, GET_COMP, NUM_POSTS_FORUM, GET_STATUS_USER, GET_EMAIL_USER, SESSIONS_NUM_USER, MODERATORS_SUBFROUM_LIST_USER };
